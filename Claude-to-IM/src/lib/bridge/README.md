...
A host-agnostic bridge that connects IM platforms (Telegram, Discord, Feishu/Lark) to local coding agents, enabling AI-powered conversations through messaging apps.
...
See `host.ts` for full interface definitions.
