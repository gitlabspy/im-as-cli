import type {
  ...
  OutboundMessage,
  SendResult,
} from 'remote-agent-control-core/src/lib/bridge/types.js';
import { BaseChannelAdapter, registerAdapterFactory } from 'remote-agent-control-core/src/lib/bridge/channel-adapter.js';
import { getBridgeContext } from 'remote-agent-control-core/src/lib/bridge/context.js';
import {
  getWeixinAccount,
