...
$SkillsDir = Join-Path $InstallHome ".claude\skills"
...
Write-Host "Installing Remote Agent Control for Claude Code..."
...
Write-Host ""
Write-Host "Done. Start a new Claude Code session and use:"
